...
interface PitchKitThumbnailProps {
  seed: number;
  customImages?: string[];
}
...
export function PitchKitThumbnail({ seed, customImages }: PitchKitThumbnailProps) {
...
export function PitchKitThumbnailSmall({ seed, customImages }: PitchKitThumbnailProps) {
  const variant = customImages?.length ? getVariantForCount(customImages.length) : getVariant(seed);
