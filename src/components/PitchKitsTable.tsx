...
import { PitchKitThumbnailSmall } from "@/components/PitchKitThumbnail";
import type { PitchKitData } from "@/data/pitchKits";

interface PitchKitsTableProps {
  data: PitchKitData[];
  selected: Set<string>;
...
export function PitchKitsTable({ data, selected, onSelectedChange, thumbnailOverrides, onThumbnailChange }: PitchKitsTableProps) {
          ...
          <TableRow key={kit.id} data-state={selected.has(kit.id) ? "selected" : undefined}>
            ...
            <TableCell>
              <div className="flex items-center gap-3">
                <PitchKitThumbnailSmall seed={index} customImages={thumbnailOverrides[kit.id]} />
